        ...
        TabView {
            ...
            StallView()
                .tabItem {
                    VStack {
                        Spacer(minLength: 20)
                        Image(uiImage: resizeImage(UIImage(systemName: "fork.knife.circle.fill")!, targetSize: CGSize(width: 20, height: 27))!)
                        Text("Stalls")
            ...
            FavoritesView()
                .tabItem {
                    VStack {
                        Spacer(minLength: 20)
                        Image(uiImage: resizeImage(UIImage(systemName: "heart.fill")!, targetSize: CGSize(width: 20, height: 27))!)
                        Text("Favorites")
                    }
                }
        }
